...
<section id="facts">
	...
	<section class="fact position--relative <?php the_title(); ?>" id="<?php the_title(); ?>" data-increment="<?php echo $increment; ?>" style="background-color: <?php the_field('background_colour'); ?>">
