<?php
/**
 * Author: Jack Davies + Ben Joy | @whatjackhasmade + @benjoy93
 * URL: realtimegames.today | @realtimegames
...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('custom-size', 500, 500, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
function create_post_type_fact()
{
    ...
    register_post_type('fact', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Fact', 'fact'), // Rename these to suit
            'singular_name' => __('Fact', 'fact'),
            'add_new' => __('Add New', 'fact'),
            'add_new_item' => __('Add New Fact', 'fact'),
            'edit' => __('Edit', 'html5blank'),
            'edit_item' => __('Edit Fact', 'fact'),
            'new_item' => __('New Fact', 'fact'),
            'view' => __('View Fact', 'fact'),
            'view_item' => __('View Fact', 'fact'),
